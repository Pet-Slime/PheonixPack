...
namespace PheonixPack.cards
{
	public static class Ankaa
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Ankaa);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Ankaa);
