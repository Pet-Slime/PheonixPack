...
namespace PheonixPack.cards
{
	public static class Motuz
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Motuz);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Motuz);
