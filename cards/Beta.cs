...
namespace PheonixPack.cards
{
	public static class Beta
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Beta);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Beta);
