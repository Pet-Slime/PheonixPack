...
namespace PheonixPack.cards
{
	public static class Rathian
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Rathian);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Rathian);
			...
			NewCard.Add(name: "PI_Rathian",
				displayedName: "Rathian",
				baseAttack: 1,
				baseHealth: 1,
				metaCategories,
