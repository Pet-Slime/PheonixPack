...
namespace PheonixPack.cards
{
	public static class Sabrina
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Sabrina);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Sabrina);
