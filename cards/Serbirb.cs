...
namespace PheonixPack.cards
{
	public static class Serbirb
	{
		public static void AddCard()
		{
			...
			Texture2D DefaultTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Serbirb);

			Texture2D eTexture = SigilUtils.LoadTextureFromResource(Resources.Artwork.Serbirb);
			...
			NewCard.Add(name: "PI_Serbirb",
				displayedName: "Serbirb",
				baseAttack: 0,
				baseHealth: 1,
				metaCategories,
